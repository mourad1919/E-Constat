...
/***/ 7249:
/*!*************************************!*\
  !*** ./src/app/model/roletouser.ts ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "RoleToUser": () => (/* binding */ RoleToUser)
/* harmony export */ });
class RoleToUser {
}
...
/* harmony import */ var _registration_page_css_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./registration.page.css?ngResource */ 8142);
...
RegistrationPage = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        ...
        styles: [_registration_page_css_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
], RegistrationPage);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var _model_roletouser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/roletouser */ 7249);
...
let UserService = class UserService {
    ...
    constructor(http) {
        this.http = http;
        this.host = "http://192.168.1.4:8081/user";
    }
    addUser(user) {
        console.log(user.password);
        return this.http.post(this.host + "/saveuserwithroleuser/" + "ROLE_USER", user);
    }
    assignRoleToUser(username) {
        let roleToUser = new _model_roletouser__WEBPACK_IMPORTED_MODULE_0__.RoleToUser();
        roleToUser.username = username;
        roleToUser.rolename = "ROLE_USER";
        return this.http.post(this.host + "/saveuser", roleToUser);
    }
    forgotPasswor(username) {
        return this.http.post(this.host + "/forgot_password/" + username, null);
    }
    resetPassword(password, token) {
        return this.http.put(this.host + "/reset_password/" + token + "/" + password, null);
    }
    getuser(username) {
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,C_Users_dell_Desktop_E_Constat_E_ConstatFrontEnd_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,C_Users_dell_Desktop_E_Constat_E_ConstatFrontEnd_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_Users_dell_Desktop_E_Constat_E_ConstatFrontEnd_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
/***/ 8142:
/*!***************************************************************!*\
  !*** ./src/app/registration/registration.page.css?ngResource ***!
  \***************************************************************/
/***/ ((module) => {

module.exports = "ion-content {\r\n    width: 100%;\r\n    align-items: center;\r\n    justify-content: center;\r\n    display: flex;\r\n    flex-direction: column;\r\n   \r\n}\r\n.container {\r\n    margin-top: 20px;\r\n    width: 90%;\r\n    margin-left: 5%;\r\n}\r\nion-button {\r\n    margin-top: 20px;\r\n}\r\n.forgot {\r\n    margin-top: 20px;    \r\n}\r\nion-item {\r\nmargin-top: 10px;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-back-button></ion-back-button>\n    </ion-buttons>\n    <ion-title>Register</ion-title>\n  </ion-toolbar>\n</ion-header>\n<ion-content>\n  <div class=\"container\">\n\n    <ion-item lines=\"full\">\n      <ion-label position=\"floating\">Prénom</ion-label>\n      <ion-input type=\"text\" required [(ngModel)]=\"user.firstname\"></ion-input>\n    </ion-item>\n    <ion-item lines=\"full\">\n      <ion-label position=\"floating\">Nom</ion-label>\n      <ion-input type=\"text\" required [(ngModel)]=\"user.lastname\"></ion-input>\n    </ion-item>\n    <ion-item lines=\"full\">\n      <ion-label position=\"floating\">Nom d'utilisateur</ion-label>\n      <ion-input type=\"text\" required [(ngModel)]=\"user.username\"></ion-input>\n    </ion-item>\n    <ion-item lines=\"full\">\n      <ion-label position=\"floating\">Email</ion-label>\n      <ion-input type=\"text\" required [(ngModel)]=\"user.email\"></ion-input>\n    </ion-item>\n    <ion-item lines=\"full\">\n      <ion-label position=\"floating\">Mot de passe</ion-label>\n      <ion-input type=\"password\" required [(ngModel)]=\"user.password\"></ion-input>\n    </ion-item>\n    \n    <ion-button type=\"submit\" color=\"success\" expand=\"block\" (click)=\"addUser()\">S'inscrire</ion-button>\n  </div>\n    \n</ion-content>";
